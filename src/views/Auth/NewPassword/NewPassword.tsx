...
const NewPassword = () => {
    ...
    const createPass = () => {
        ...
        try {
            API_REQUEST("POST", endPoints.newPassword, data,
                ((sucess: any) => {
                    setIsLoading(false);
    ...
    return (
        <SafeAreaView style={styles.wrapper}>
            <AppHeader title={en.Headings.PasswordCreation} onBackPress={() => navigation.goBack()} />
            ...
            >
                ...
                >
                    <View style={styles.header}>
                        <LargeText text={en.SignIn.CreateNewPass} />
                        <NormalText text={en.SignIn.pleaseNewPass} customStyle={{ textAlign: 'center', marginTop: 10 }} />
                    </View>
                    <View style={styles.inputs}>
                        <AppInput isPassword secureTextEntry={hidePassword} hidePass={() => setHidePassword(!hidePassword)} value={password} onChangeText={setPassword} placeholder={en.Inputs.newPass} />
