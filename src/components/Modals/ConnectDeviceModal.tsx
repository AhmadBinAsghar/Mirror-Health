...
const ConnectDeviceModal = ({ visible, onClose, onContinue }: connect) => {
    return (
        <Modal
            isVisible={visible}
        ...
        >
            <View style={[styles.container, styles.boxShadow]}>
                <LargeText text={en.Modals.Connectdevice} customStyle={{ fontSize: 20 }} />
                <SmallText text={en.Modals.ConnectToGetMetrics} customStyle={{ marginTop: 6 }} />
