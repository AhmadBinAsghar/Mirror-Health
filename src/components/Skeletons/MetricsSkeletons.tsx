...
const MetricsSkeletons = ({ color }: Shimmer) => {
    return (
        <SkeletonPlaceholder highlightColor={color} shimmerWidth={250} speed={1400} >
            <SkeletonPlaceholder.Item borderRadius={100}>
                ...
                <SkeletonPlaceholder.Item width={wp(60)} height={20} marginLeft={25} />
                <SkeletonPlaceholder.Item width={wp(88)} height={hp(18)} borderRadius={20} marginVertical={20} alignSelf='center' />
...
export default MetricsSkeletons